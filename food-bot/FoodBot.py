...
# Bot that takes the top daily submission from r/food and tweets it
def FoodBot():
    ...
    while True:
        ...
        top_submissions = reddit.subreddit('food').top(time_filter='day', limit=4)
        
        # Go through top submissions tweeting 1 every 6H
        try:
